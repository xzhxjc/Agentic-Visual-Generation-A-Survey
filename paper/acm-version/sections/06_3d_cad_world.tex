...
ShapeCraft uses a multi-agent system with a Graph-based Procedural Shape representation to generate structured, editable 3D assets: Parser, Coder, and Evaluator agents decompose text into semantic components, iteratively render, score, and refine candidate geometries, with component-aware texture applied post-construction~\cite{avg251017603}. 
